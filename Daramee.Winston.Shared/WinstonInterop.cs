...
internal static class WinstonInterop
{
    ...
    public interface IShellItem
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        void GetDisplayName([In] ShellItemGetDisplayName sigdnName,
    ...
    public static extern long SendMessage(IntPtr hWnd, TaskDialogMessages Msg, IntPtr wParam,
        ref TaskDialogConfig lParam);
    ...
    delegate long TaskDialogDelegate(IntPtr hwndOwner, IntPtr hInstance,
    ...
    delegate long TaskDialogIndirectDelegate(ref TaskDialogConfig pTaskConfig, out int pnButton,
    ...
    class HMODULE
    {
        ...
        public static implicit operator IntPtr(HMODULE m)
        {
            return m.module;
        }

        public static implicit operator HMODULE(IntPtr p)
        {
            return new HMODULE(p);
        }
    }
    ...
    static void LoadTaskDialog()
    {
        ...
        foreach (string dir in Directory.EnumerateDirectories(Path.Combine(systemDirectory, "WinSxS"),
                     $"{(IntPtr.Size == 4 ? "x86" : "amd64")}_microsoft.windows.common-controls_6595b64144ccf1df_6.*"))
        {
            ...
            if (taskDialog == IntPtr.Zero || taskDialogIndirect == IntPtr.Zero)
                throw new PlatformNotSupportedException();

#pragma warning disable 0618
            taskDialogAction =
                Marshal.GetDelegateForFunctionPointer(taskDialog, typeof(TaskDialogDelegate)) as TaskDialogDelegate;
            taskDialogIndirectAction =
                Marshal.GetDelegateForFunctionPointer(taskDialogIndirect, typeof(TaskDialogIndirectDelegate)) as
                    TaskDialogIndirectDelegate;
#pragma warning restore 0618
    ...
    public static long TaskDialog(IntPtr OwnerWindowHandle, string windowTitle, string mainInstruction,
        string content,
        Dialogs.TaskDialogCommonButtonFlags commonButtons, IntPtr iconHandle, out int button)
    {
        if (taskDialogAction == null)
            LoadTaskDialog();
        return taskDialogAction(OwnerWindowHandle, IntPtr.Zero, windowTitle, mainInstruction, content,
            commonButtons, iconHandle, out button);
    }
    ...
    public interface IFileDialog : IModalWindow
    {
        ...
        void SetFileTypes(uint cFileTypes,
            ...
            CommonDialogFilterSpecification[] rgFilterSpec);
    ...
    public interface IFileSaveDialog : IFileDialog
    {
        ...
        void ApplyProperties([In, MarshalAs(UnmanagedType.Interface)] IShellItem psi,
            [In, MarshalAs(UnmanagedType.Interface)] IntPtr pStore, [In] ref IntPtr hwnd,
