...
public class TaskDialogResult
{
    ...
    public override string ToString() =>
        $"{{Button: {Button}, Radio Button: {RadioButton}, Verification: {Verification}}}";
}
...
public class ButtonClickedEventArgs : TaskDialogEventArgs
{
    ...
    public ButtonClickedEventArgs(int buttonId)
    {
        ButtonId = buttonId;
    }
}
...
public class ExpandButtonClickedEventArgs : TaskDialogEventArgs
{
    ...
    public ExpandButtonClickedEventArgs(bool isExpanded)
    {
...
public class HyperLinkClickedEventArgs : TaskDialogEventArgs
{
    ...
    public HyperLinkClickedEventArgs(string hyperlinkUrl)
    {
...
public class VerificationClickedEventArgs : TaskDialogEventArgs
{
    ...
    public VerificationClickedEventArgs(bool isVerificationChecked)
    {
...
public abstract class TaskDialogIcon
{
    ...
    {
        return new IntPtr((int) (ulong) (ushort) resId);
    }
...
public class TaskDialogNativeIcon : TaskDialogIcon
{
    ...
    public TaskDialogNativeIcon(IntPtr hIcon)
    {
        _icon = hIcon;
    }
}
...
public class TaskDialog
{
    ...
    {
        get { return config.CommonButtons; }
        set { config.CommonButtons = value; }
    }

    public string Title
    {
        get { return config.WindowTitle; }
        set { config.WindowTitle = value; }
    }
    ...
    {
        get { return config.MainInstruction; }
        set { config.MainInstruction = value; }
    }

    public string Content
    {
        get { return config.Content; }
        set { config.Content = value; }
    }
    ...
    {
        get { return config.DefaultButton; }
        set { config.DefaultButton = value; }
    }
    ...
    {
        get { return config.DefaultRadioButton; }
        set { config.DefaultRadioButton = value; }
    }

    public string VerificationText
    {
        get { return config.VerificationText; }
        set { config.VerificationText = value; }
    }

    public string ExpandedInformation
    {
        get { return config.ExpandedInformation; }
        set { config.ExpandedInformation = value; }
    }

    public string ExpandedControlText
    {
        get { return config.ExpandedControlText; }
        set { config.ExpandedControlText = value; }
    }

    public string CollapsedControlText
    {
        get { return config.CollapsedControlText; }
        set { config.CollapsedControlText = value; }
    }
    ...
    {
        get { return config.Footer; }
        set { config.Footer = value; }
    }
    ...
    private bool UseHICONMain
    {
        ...
        set
        {
            if (value) config.Flags |= TaskDialogFlags.UseHICONMain;
            else config.Flags &= ~TaskDialogFlags.UseHICONMain;
        }
    }
    ...
    private bool UseHICONFooter
    {
        ...
        set
        {
            if (value) config.Flags |= TaskDialogFlags.UseHICONFooter;
            else config.Flags &= ~TaskDialogFlags.UseHICONFooter;
        }
    }
    ...
    public bool EnableHyperlinks
    {
        ...
        set
        {
            if (value) config.Flags |= TaskDialogFlags.EnableHyperlinks;
            else config.Flags &= ~TaskDialogFlags.EnableHyperlinks;
        }
    }
    ...
    public bool AllowDialogCancellation
    {
        ...
        set
        {
            if (value) config.Flags |= TaskDialogFlags.AllowDialogCancellation;
            else config.Flags &= ~TaskDialogFlags.AllowDialogCancellation;
        }
    }
    ...
    public bool UseCommandLinks
    {
        ...
        set
        {
            if (value) config.Flags |= TaskDialogFlags.UseCommandLinks;
            else config.Flags &= ~TaskDialogFlags.UseCommandLinks;
        }
    }
    ...
    public bool UseCommandLinksNoIcon
    {
        ...
        set
        {
            if (value) config.Flags |= TaskDialogFlags.UseCommandLinksNoIcon;
            else config.Flags &= ~TaskDialogFlags.UseCommandLinksNoIcon;
        }
    }
    ...
    public bool ExpandFooterArea
    {
        ...
        set
        {
            if (value) config.Flags |= TaskDialogFlags.ExpandFooterArea;
            else config.Flags &= ~TaskDialogFlags.ExpandFooterArea;
        }
    }
    ...
    public bool ExpandedByDefault
    {
        ...
        set
        {
            if (value) config.Flags |= TaskDialogFlags.ExpandedByDefault;
            else config.Flags &= ~TaskDialogFlags.ExpandedByDefault;
        }
    }
    ...
    public bool VerificationFlagChecked
    {
        ...
        set
        {
            if (value) config.Flags |= TaskDialogFlags.VerificationFlagChecked;
            else config.Flags &= ~TaskDialogFlags.VerificationFlagChecked;
        }
    }
    ...
    public bool ShowProgressBar
    {
        ...
        set
        {
            if (value) config.Flags |= TaskDialogFlags.ShowProgressBar;
            else config.Flags &= ~TaskDialogFlags.ShowProgressBar;
        }
    }
    ...
    public bool ShowMarqueeProgressBar
    {
        ...
        set
        {
            if (value) config.Flags |= TaskDialogFlags.ShowMarqueeProgressBar;
            else config.Flags &= ~TaskDialogFlags.ShowMarqueeProgressBar;
        }
    }
    ...
    public bool CallbackTimer
    {
        ...
        set
        {
            if (value) config.Flags |= TaskDialogFlags.CallbackTimer;
            else config.Flags &= ~TaskDialogFlags.CallbackTimer;
        }
    }
    ...
    public bool PositionRelativeToWindow
    {
        ...
        set
        {
            if (value) config.Flags |= TaskDialogFlags.PositionRelativeToWindow;
            else config.Flags &= ~TaskDialogFlags.PositionRelativeToWindow;
        }
    }
    ...
    public bool RTLLayout
    {
        ...
        set
        {
            if (value) config.Flags |= TaskDialogFlags.RTLLayout;
            else config.Flags &= ~TaskDialogFlags.RTLLayout;
        }
    }
    ...
    public bool NoDefaultRadioButton
    {
        ...
        set
        {
            if (value) config.Flags |= TaskDialogFlags.NoDefaultRadioButton;
            else config.Flags &= ~TaskDialogFlags.NoDefaultRadioButton;
        }
    }
    ...
    public bool CanBeMinimized
    {
        ...
        set
        {
            if (value) config.Flags |= TaskDialogFlags.CanBeMinimized;
            else config.Flags &= ~TaskDialogFlags.CanBeMinimized;
        }
    }
    ...
    public bool NoSetForeground
    {
        ...
        set
        {
            if (value) config.Flags |= TaskDialogFlags.NoSetForeground;
            else config.Flags &= ~TaskDialogFlags.NoSetForeground;
        }
    }
    ...
    public bool SizeToContent
    {
        ...
        set
        {
            if (value) config.Flags |= TaskDialogFlags.SizeToContent;
            else config.Flags &= ~TaskDialogFlags.SizeToContent;
        }
    }
    ...
    public TaskDialog()
    {
        ...
        config.Callback =
            (IntPtr hwnd, TaskDialogNotification msg, IntPtr wParam, IntPtr lParam, IntPtr lpRefData) =>
            {
    ...
    public static int Show(IntPtr parentHwnd, string windowTitle, string mainInstruction, string content,
        TaskDialogCommonButtonFlags commonButtons, TaskDialogIcon icon)
    {
        long hr = WinstonInterop.TaskDialog(parentHwnd, windowTitle, mainInstruction, content, commonButtons,
            icon.IconHandle, out int button);
        if (0 != hr)
...
#endif
    public static int Show(string windowTitle, string mainInstruction, string content,
        TaskDialogCommonButtonFlags commonButtons, TaskDialogIcon icon)
    {
